...
def evaluate(groundtruth, parsedresult):
    ...
    print('Precision: %.4f, Recall: %.4f, F1_measure: %.4f, Parsing_Accuracy: %.4f, Silhouette Score: %0.4f'%(precision, recall, f_measure, accuracy, silhoutte))
    return f_measure, accuracy, silhoutte
